...
export function PhotoPicker({ photos, onChange }: PhotoPickerProps) {
  ...
  return (
    <div>
      ...
      {canAdd && (
        <div className="flex gap-2">
          <button
            ...
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 border-2 border-dashed border-[#2E6A4A]
                       text-[10px] uppercase tracking-wider text-[#2E6A4A] hover:bg-[#D3E4D7] hover:border-[#2E6A4A] transition-colors
      ...
      {loading && (
        <p className="text-[10px] text-[#2E6A4A] mt-1.5 flex items-center gap-1 font-mono">
