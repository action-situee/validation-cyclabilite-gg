      ...
      >
        ...
        <div className="bg-[#2E6A4A] p-5 border-b-2 border-[#0a0a0a] flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-[#D3E4D7] text-sm uppercase tracking-[0.15em]">Questionnaire rapide</h2>
          </div>
        ...
        {submitted && (
          <div className="p-10 text-center">
            <div
              className="w-14 h-14 border-2 border-[#2E6A4A] bg-[#D3E4D7] flex items-center justify-center mx-auto mb-4"
        ...
        {!submitted && !alreadyAnswered && (
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            <p className="text-[12px] text-[#5c5c5c] leading-relaxed">
              Quelques questions pour recueillir votre avis global sur <strong className="text-[#2E6A4A]">l'indice de cyclabilité</strong> et son utilisation comme outil de planification transfrontalière.
            </p>

            {/* Q1 – closed */}
            <fieldset className="space-y-2.5">
              <legend className="text-[11px] uppercase tracking-[0.12em] text-[#0a0a0a] border-b-2 border-[#0a0a0a] pb-2 mb-1 block w-full">
                <span className="font-mono text-[#2E6A4A] mr-2">01</span>
            ...
            <fieldset className="space-y-2.5">
              <legend className="text-[11px] uppercase tracking-[0.12em] text-[#0a0a0a] border-b-2 border-[#0a0a0a] pb-2 mb-1 block w-full">
                <span className="font-mono text-[#2E6A4A] mr-2">02</span>
            ...
            <fieldset className="space-y-2.5">
              <legend className="text-[11px] uppercase tracking-[0.12em] text-[#0a0a0a] border-b-2 border-[#0a0a0a] pb-2 mb-1 block w-full">
                <span className="font-mono text-[#2E6A4A] mr-2">03</span>
